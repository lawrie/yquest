...
Cls:
	move.l #$00010000,a3	;Address to clear
...
GetScreenPos: ; d1=x d2=y - returns result in A2
	...
	move.l #$00010000,a2	;Screen starts at $10000
	add.l d4,a2
	add.l d1,a2
	moveM.l (sp)+,d1-d4
	rts
...
Player_ReadControlsDual:;---7654S321RLDU
	moveM.l d1-d2,-(sp)	
        MOVE.B  KEYROW1.L,D1    ; Get Keyrow 0
...
SpriteData:
	incbin "SQL_YQuest.RAW"
	incbin "SQL_YQuest2.RAW"
	incbin "SQL_YQuest3.RAW"
	incbin "SQL_YQuest4.RAW"
BitmapDataEnd:	
	even
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	include "V1_ChibiSound.asm"
	include "Multiplatform_BCD.asm"
	include "BasicFunctions.asm"	
	include "MultiPlatform_ShowDecimal.asm"
